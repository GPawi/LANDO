function  [p95_4, p68_2, calprob, medage] = udmatcal(labdet, laberr, calcurve, yeartype, varargin)
% [p95_4, p68_2, calprob, medage] = udmatcal(labdet, laberr, calcurve, yeartype)
%
...
% =================================
%
% [p95_4, p68_2, prob, medage] = udmatcal(1175, 30, 'IntCal20', 'BCE/CE');
% Calibrate a 14C age of 1175±30 14C yr BP using IntCal20 with output in BCE/CE.
%
% [p95_4, p68_2, prob, medage] = udmatcal(23175, 60, 'Marine20', 'CalBP',...
...
%
% [p95_4, p68_2, prob, medage] = udmatcal(1175, 30, 'IntCal20', 'CalBP', 'plot', 0);
...
% LANDO-specific: warnings have been commented out, since in the multi-core case the stdout is too long - uncomment if you want to see warnings again
